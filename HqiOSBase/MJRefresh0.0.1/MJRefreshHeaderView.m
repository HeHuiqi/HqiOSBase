...
//        NSLog(@"normal2pullingOffsetY。。。。%f",normal2pullingOffsetY);
        ...
        NSLog(@"self.scrollView.mj_contentOffsetY=%f",self.scrollView.mj_contentOffsetY);
        NSLog(@"self.scrollView.mj_contentInsetTop=%f",self.scrollView.mj_contentInsetTop);
...
//                    self.scrollView.mj_contentOffsetY = 0;
//                    self.scrollView.mj_contentInsetTop = 0;
                    NSLog(@"self.scrollView.mj_contentOffsetY222=%f",self.scrollView.mj_contentOffsetY);
                }];
            } else {
                // 执行动画
		...
		case MJRefreshStateRefreshing: // 正在刷新中
        {
            ...
            [UIView animateWithDuration:MJRefreshFastAnimationDuration animations:^{
                ...
                NSLog(@"MJRefreshStateRefreshing==top== %f",top);
